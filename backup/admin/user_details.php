...
$admins_details="SELECT * FROM users WHERE id = '{$getadmin}'";
...
?>
			...
			<div class="container-fluid">
				<div class="form-head page-titles d-flex align-items-center mb-sm-4 mb-3">
					<div class="mr-auto">
						...
						<ol class="breadcrumb">
							<li class="breadcrumb-item active"><a href="javascript:void(0)"><?=$data['permissions']?></a></li>
							<li class="breadcrumb-item"><a href="javascript:void(0)"><?=$data['id']?></a></li>
						</ol>
					</div>
										...
										<div class="d-sm-flex mb-3">
											<div class="img-card mb-sm-0 mb-3">	
												...
												<div class="info d-flex align-items-center p-md-3 p-2 bg-primary">
													...
													<div>
														<p class="fs-14 text-white op5 mb-1"><?=$data['position_clinic']?></p>
											...
											<div class="card-info d-flex align-items-start">
												<div class="mr-auto pr-3">
													...
													Registrado em <?=formatdate($data['join_date']);?></span>
												</div>
											...
											<div class="col-sm-7 mb-sm-0 mb-3">
												<div class="d-flex">
													...
													<div>
														...
														<p class="fs-18 mb-0 text-black"><?=$data['address']?><strong class="d-block">Topo do Camama 94107</strong></p>
													</div>
												</div>
											</div>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p><p>Todos os direitos reservados © Clínica Arco-íris   &amp; desevolvido por <a href="#" target="_blank">Gilgrácio Francisco & Nuno Raphael </a> 2022</p></p>
            </div>
        </div>
        <!--**********************************
            Footer end

...
?>
        ...
        ***********************************-->
          <div class="content-body">
            ...
            $sql = "SELECT * FROM doctores WHERE id = $lodagoid ORDER BY full_name";
 ...
 /* $emailQuery = $db->query("SELECT * FROM users WHERE email='$email'");
  ...
  if (!empty($errors)) {
   ...
   if (isset($_GET['edit'])){
     ...
     $db -> query($insertSql);
echo "<script>alert('Salvo'); window.location = './configuracao.php';</script>";
  }
}
                                        ...
                                        <td>
                                            <div class="dropdown ml-auto text-right">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="configuracao.php?delete=<?=$user['id'];?>">Delete</a>
                                                    <?php endif;?>
                                                </div>
                                            </div>
                                        </td>                                               

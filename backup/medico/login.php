                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <h4 class="text-center mb-4 text-white">Bem vindo! Faça o logim para aceder a conta de Medico.</h4>
                                    <form action="login.php" method="post">
                                        <?php
                                            if($_POST){
                                                ...
                                                $query=$db->query("SELECT * FROM doctores WHERE email = '$email'");
                                                $user=mysqli_fetch_assoc($query);
                                                $userCount = mysqli_num_rows($query);
                                                if ($userCount<1) {
                                                  $errors[] = "Verifique a senha ou email123";
                                                }
                                    ...
                                    <div class="new-account mt-3">
                                        <p class="text-white">Não tem uma conta? <a class="text-white" href="#">Inscrever-se</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>

 ...
 /* $emailQuery = $db->query("SELECT * FROM users WHERE email='$email'");
  ...
  if (!empty($errors)) {
   echo display_errors($errors);
      ...
      $insertSql = "INSERT INTO relatorio_consulta (`doctor_id`, `patient_id`, `consulta_id`, `num_relatorio`, `descricao`,`comentario_medico`,`local_teste`,`data_teste`,`altura`,`peso`,`idade`) VALUES ('$doctor_id', '$patient_id', '$consulta_id', '$num_relatorio','$descricao', '$comentario_medico','$local_teste','$data_teste','$altura','$peso','$idade')";
      $_SESSION['success_flash'] = "Consulta marcada com sucesso";
      
   if (isset($_GET['edit'])){
         $insertSql = "UPDATE relatorio_consulta SET `doctor_id`='$doctor_id', `patient_id` ='$patient_id', `consulta_id` ='$consulta_id', `num_relatorio` ='$num_relatorio',  `descricao` ='$descricao', `comentario_medico` ='$comentario_medico', `local_teste` ='$local_teste', `data_teste` ='$data_teste', `altura` ='$altura', `peso` ='$peso', `idade` ='$idade'  WHERE relatorio_id='$edit_id'";
...
echo "<script>alert('Salvo'); window.location = './lista_marcacoes.php';</script>";
  ...
  ?>
                                    ...
                                    <form>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="descricao" class="form-control" id="descricao" value="" required>
                                            </div>
                   ...
                   <div>
                        <a href="relatorios.php?add=1" class="btn btn-primary mr-3" id="add-product-btn">Criar Consultas</a>

...
$admins_details="SELECT receita_medica.receita_id, receita_medica.relatorio_id, receita_medica.num_receita, receita_medica.descricao, receita_medica.comentario_medico, relatorio_consulta.relatorio_id, relatorio_consulta.consulta_id, relatorio_consulta.doctor_id, relatorio_consulta.patient_id, relatorio_consulta.num_relatorio, patient.pacient_nomecompleto, patient.id, patient.cellphone, patient.email, doctores.full_name, doctores.especialidade, doctores.cellphone, doctores.id, consulta.data_consulta, consulta.n_consulta, consulta.consultaid, consulta.n_consulta, tipo_consulta.id, tipo_consulta.nome FROM receita_medica LEFT JOIN relatorio_consulta ON receita_medica.relatorio_id = relatorio_consulta.relatorio_id   LEFT JOIN doctores ON relatorio_consulta.doctor_id = doctores.id LEFT JOIN patient ON relatorio_consulta.patient_id = patient.id LEFT JOIN consulta ON relatorio_consulta.consulta_id = consulta.consultaid LEFT JOIN tipo_consulta on consulta.tipo_consultaid = tipo_consulta.id WHERE receita_medica.receita_id = '{$getadmin}'";
$datas=$db->query($admins_details);
$data = mysqli_fetch_assoc($datas);
$saber_consulta="SELECT receita_medica.receita_id, receita_medica.doctor_id, receita_medica.patient_id, receita_medica.consulta_id, receita_medica.relatorio_id, receita_medica.descricao, receita_medica.num_receita, receita_medica.comentario_medico, relatorio_consulta.relatorio_id, relatorio_consulta.relatorio_id, relatorio_consulta.consulta_id, relatorio_consulta.doctor_id, relatorio_consulta.patient_id, relatorio_consulta.num_relatorio, relatorio_consulta.descricao, relatorio_consulta.data_teste, relatorio_consulta.local_teste, relatorio_consulta.comentario_medico, patient.pacient_nomecompleto, patient.id, patient.cellphone, patient.email, doctores.full_name, doctores.especialidade, doctores.cellphone, doctores.id, consulta.data_consulta FROM receita_medica LEFT JOIN doctores ON receita_medica.doctor_id = doctores.id LEFT JOIN patient ON patient.id = receita_medica.patient_id LEFT JOIN consulta ON consulta.consultaid = receita_medica.consulta_id LEFT JOIN relatorio_consulta ON relatorio_consulta.relatorio_id = receita_medica.relatorio_id WHERE receita_medica.receita_id  = '{$getadmin}'";
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="form-head page-titles d-flex align-items-center mb-sm-4 mb-3">
					<div class="mr-auto">
						<h2 class="text-black font-w600">Receitas Medica</h2>
						<ol class="breadcrumb">
							<li class="breadcrumb-item active"><a href="javascript:void(0)"><?=$data['status']?></a></li>
							<li class="breadcrumb-item"><a href="javascript:void(0)">Receitas nº: <strong><?=$data['num_receita']?></strong></a></li>
						</ol>
					</div>
											...
											<div class="img-card mb-sm-0 mb-3">	
												...
												<div class="info d-flex align-items-center p-md-3 p-2 bg-primary">
													...
													<div>
														...
														<span class="fs-18 text-white"><?=$data['pacient_nomecompleto']?></span>
													</div>
												</div>
											</div>
											<div class="card-info d-flex align-items-start">
												<div class="mr-auto pr-3">
													<h2 class="font-w600 mb-2 text-black"><?=$data['pacient_nomecompleto']?></h2>
										...
										<div class="row">
											<div class="col-sm-7 mb-sm-0 mb-3">
												<div class="d-flex">
													...
													<div>
														<span class="d-block mb-1">Receita</span>
														<p class="fs-18 mb-0 text-black"><strong class="d-block"><?=$data['descricao']?></strong></p>
													</div>
												</div>
											</div>
											...
											<div class="card-body">
												<div class="media align-items-center">
													...
													<div class="media-body">
														<span class="d-block mb-1">Nome do Medico</span>
														<p class="fs-18 mb-0 text-black"><?=$nome_medico['full_name']?></p>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="col-sm-7 mb-sm-0 mb-3">
												<div class="d-flex">
													<div>
														...
														<p class="fs-18 mb-0 text-black"><strong class="d-block"><?=$data['comentario_medico']?></strong></p>
													</div>
												</div>
											</div>
										...
										<div class="card">
											<div class="card-body">
												<div class="media align-items-center">
													<i class="las la-envelope-open fs-30 text-primary mr-3"></i>
													<div class="media-body">
														<span class="d-block mb-1">Data do Exame</span>
														<p class="fs-18 mb-0 text-black"><?=$data['data_teste']?></p>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="card">
											<div class="card-body">
												<div class="media align-items-center">
													<i class="las la-envelope-open fs-30 text-primary mr-3"></i>
													<div class="media-body">
														<span class="d-block mb-1">Local do Exame</span>
														<p class="fs-18 mb-0 text-black"><?=$data['local_teste']?></p>
													</div>
												</div>
											</div>
										</div>

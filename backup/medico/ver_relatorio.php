...
$admins_details="SELECT relatorio_consulta.relatorio_id, relatorio_consulta.consulta_id, relatorio_consulta.altura, relatorio_consulta.peso, relatorio_consulta.local_teste, relatorio_consulta.data_teste, relatorio_consulta.idade, relatorio_consulta.doctor_id, relatorio_consulta.patient_id, relatorio_consulta.num_relatorio, relatorio_consulta.descricao, relatorio_consulta.comentario_medico, patient.pacient_nomecompleto, patient.id, patient.cellphone, patient.email, doctores.full_name, doctores.especialidade, doctores.cellphone, doctores.id, consulta.data_consulta, consulta.motivo_consulta, consulta.sintomas, consulta.tipo_consultaid, tipo_consulta.id, tipo_consulta.nome, consulta.tipo_consultaid FROM relatorio_consulta LEFT JOIN doctores ON relatorio_consulta.doctor_id = doctores.id LEFT JOIN patient ON relatorio_consulta.patient_id = patient.id LEFT JOIN consulta ON relatorio_consulta.consulta_id = consulta.consultaid LEFT JOIN tipo_consulta ON consulta.tipo_consultaid = tipo_consulta.id WHERE relatorio_consulta.relatorio_id  = '{$getadmin}'";
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="form-head page-titles d-flex align-items-center mb-sm-4 mb-3">
					<div class="mr-auto">
						<h2 class="text-black font-w600">Relatorio (Resultado) da Consulta</h2>
						<ol class="breadcrumb">
							<li class="breadcrumb-item active"><a href="javascript:void(0)"><?=$data['status']?></a></li>
							<li class="breadcrumb-item"><a href="javascript:void(0)">Relatorio nº: <strong><?=$data['num_relatorio']?></strong></a></li>
						</ol>
					</div>
											...
											<div class="card-body">
												<div class="media align-items-center">
													...
													<div class="media-body">
														<span class="d-block mb-1">Idade</span>
														<p class="fs-18 mb-0 text-black"><?=$data['idade']?></p>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="card">
											<div class="card-body">
												<div class="media align-items-center">
													...
													<div class="media-body">
														<span class="d-block mb-1">Peso</span>
														<p class="fs-18 mb-0 text-black"><?=$data['peso']?></p>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="card">
											<div class="card-body">
												<div class="media align-items-center">
													...
													<div class="media-body">
														<span class="d-block mb-1">Altura</span>
														<p class="fs-18 mb-0 text-black"><?=$data['altura']?></p>
													</div>
												</div>
											</div>
										</div>

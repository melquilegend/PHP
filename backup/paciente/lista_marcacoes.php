...
echo "<script>alert('Salvo'); window.location = './lista_marcacoes.php';</script>";
  ...
  ?>
                   ...
                   <div>
                        <a href="lista_marcacoes.php?add=1" class="btn btn-primary mr-3" id="add-product-btn">Marcar Consultas</a>

...
$admins_details="SELECT consulta.consultaid, consulta.n_consulta, tipo_consulta.id, tipo_consulta.nome, consulta.doctor_id, consulta.hora_consulta, patient.pacient_nomecompleto, patient.address, patient.cellphone, patient.email, consulta.tipo_consultaid, consulta.motivo_consulta, consulta.sintomas, consulta.data_consulta, consulta.status, consulta.visita_clinica, consulta.comentario_doctor FROM consulta LEFT JOIN doctores ON consulta.doctor_id= doctores.id LEFT JOIN patient ON consulta.patient_id=patient.id LEFT JOIN tipo_consulta on consulta.tipo_consultaid = tipo_consulta.id WHERE consulta.consultaid = '{$getadmin}'";
$datas=$db->query($admins_details);
$data = mysqli_fetch_assoc($datas);
$saber_consulta="SELECT consulta.consultaid, consulta.n_consulta, tipo_consulta.id, tipo_consulta.nome, consulta.doctor_id, consulta.hora_consulta, consulta.tipo_consultaid, doctores.full_name, doctores.id, consulta.motivo_consulta, consulta.sintomas, consulta.data_consulta, consulta.status, consulta.visita_clinica, consulta.comentario_doctor FROM consulta LEFT JOIN doctores ON consulta.doctor_id= doctores.id LEFT JOIN tipo_consulta on consulta.tipo_consultaid = tipo_consulta.id WHERE consulta.consultaid = '{$getadmin}'";

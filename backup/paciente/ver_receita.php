        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="form-head page-titles d-flex align-items-center mb-sm-4 mb-3">
					<div class="mr-auto">
						<h2 class="text-black font-w600">Receita da Consulta</h2>
						<ol class="breadcrumb">
							<li class="breadcrumb-item active"><a href="javascript:void(0)"><?=$data['status']?></a></li>
							<li class="breadcrumb-item"><a href="javascript:void(0)">Receita nº: <strong><?=$data['num_receita']?></strong></a></li>
						</ol>
					</div>
										...
										<div class="row">
											<div class="col-sm-7 mb-sm-0 mb-3">
												<div class="d-flex">
													...
													<div>
														<span class="d-block mb-1">Receita Medica</span>

...
$query=$db->query("SELECT * FROM consulta ORDER BY n_consulta");
 $userCount = mysqli_num_rows($query);
 $efetuada=$db->query("SELECT * FROM doctores  ORDER BY full_name");
 $efetuadaCount = mysqli_num_rows($efetuada);
 $consulta=$db->query("SELECT * FROM patient full_name");

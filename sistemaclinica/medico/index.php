...
$query=$db->query("SELECT * FROM consulta WHERE doctor_id = '$idconsultaid' AND status = 'Marcada' ORDER BY consultaid");
 $userCount = mysqli_num_rows($query);
 $efetuada=$db->query("SELECT * FROM consulta WHERE doctor_id = '$idconsultaid' AND status = 'Efetuada' ORDER BY consultaid");
 $efetuadaCount = mysqli_num_rows($efetuada);
 $consulta=$db->query("SELECT * FROM consulta WHERE doctor_id = '$idconsultaid' AND status = 'Pendente' ORDER BY consultaid");
 $consultaCount = mysqli_num_rows($consulta);
?>
<body>
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="form-head d-flex align-items-center mb-sm-4 mb-3">
					<div class="mr-auto">
						<h2 class="text-black font-w600">Painel</h2>
						<p class="mb-0">Clínica Arco-íris Admin Painel</p>
					</div>
							...
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body mr-3">
										<h2 class="fs-34 text-black font-w600"><?=$userCount?></h2>
					...
					<div class="col-xl-3  col-sm-6">
						<div class="card">
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body mr-3">
										<h2 class="fs-34 text-black font-w600"><?=$efetuadaCount?></h2>
										<span>Total de Pacientes consultados</span>
									</div>
									<svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div class="col-xl-3  col-sm-6">
						<div class="card">
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body mr-3">
										<h2 class="fs-34 text-black font-w600"><?=$consultaCount;?></h2>
										<span>Total de Consultas a Marcar</span>
									</div>
									<svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">

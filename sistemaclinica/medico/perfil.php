        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="form-head page-titles d-flex align-items-center mb-sm-4 mb-3">
					<div class="mr-auto">
						<h2 class="text-black font-w600">Detalhes de administrador</h2>
						<ol class="breadcrumb">
							<li class="breadcrumb-item active"><a href="javascript:void(0)"><?=$user_data['permissions']?></a></li>
							<li class="breadcrumb-item"><a href="javascript:void(0)"><?=$user_data['id']?></a></li>
						</ol>
					</div>
							...
							<div class="col-xl-12">
								<div class="card details-card">
									...
									<div class="card-body">
										<div class="d-sm-flex mb-3">
											<div class="img-card mb-sm-0 mb-3">	
												...
												<div class="info d-flex align-items-center p-md-3 p-2 bg-primary">
													...
													<div>
														<p class="fs-14 text-white op5 mb-1"><?=$user_data['position_clinic']?></p>
														<span class="fs-18 text-white"><?=$user_data['especialidade']?></span>
													</div>
												</div>
											</div>
											<div class="card-info d-flex align-items-start">
												<div class="mr-auto pr-3">
													<h2 class="font-w600 mb-2 text-black"><?=$user_data['full_name']?></h2>
													<p class="mb-2"><?=$user_data['id']?></p>
													<span class="date">
													<i class="las la-clock"></i>
													Registrado em <?=formatdate($user_data['join_date']);?></span>
												</div>
										...
										<h4 class="fs-20 text-black font-w600">Sobre</h4>
										<p>
											<?=$user_data['about']?>
										</p>
											...
											<div class="col-sm-7 mb-sm-0 mb-3">
												<div class="d-flex">
													...
													<div>
														...
														<p class="fs-18 mb-0 text-black"><?=$user_data['address']?><strong class="d-block"></strong></p>
													</div>
												</div>
											</div>
											...
											<div class="card-body">
												<div class="media align-items-center">
													...
													<div class="media-body">
														<span class="d-block mb-1">Telefone</span>
														<p class="fs-18 mb-0 text-black"><?=$user_data['cellphone']?></p>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="card-body">
												<div class="media align-items-center">
													...
													<div class="media-body">
														...
														<p class="fs-18 mb-0 text-black"><?=$user_data['email']?></p>
													</div>
												</div>
											</div>
										</div>

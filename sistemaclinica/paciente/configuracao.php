          ...
          <div class="content-body">
            ...
            <div class="container-fluid">
                <div class="form-head d-flex mb-sm-4 mb-3">
                    <div class="mr-auto">
                        <h2 class="text-black font-w600"><strong><?=$user_data['pacient_nomecompleto'];?></strong> </h2>
                        <p class="mb-0"><?=$user_data['permissions'];?></strong> </p>
            ...
            $sql = "SELECT * FROM patient WHERE id = $lodagoid ORDER BY pacient_nomecompleto";
...
if (isset($_GET['edit'])) {
   ...
   $pacient_nomecompleto = ((isset( $_POST['pacient_nomecompleto']) && $_POST['pacient_nomecompleto'] != '')?sanitize($_POST['pacient_nomecompleto']):$usersquery['pacient_nomecompleto']);
...
if ($_POST) {
 ...
 /* $emailQuery = $db->query("SELECT * FROM users WHERE email='$email'");
  ...
  $errors=array();
  $required=Array('pacient_nomecompleto','email','password','permissions');
  ...
  if (!empty($errors)) {
   echo display_errors($errors);
    ...
    $hashed =  password_hash($password, PASSWORD_DEFAULT);
      $insertSql = "INSERT INTO patient (`pacient_nomecompleto`, `email`, `address`, `cellphone`, `about`, `password`, `permissions`) VALUES ('$pacient_nomecompleto', '$email', '$address', '$cellphone', '$about', '$hashed', '$permissions')";
      $_SESSION['success_flash'] = "Usuario adicionado com sucesso";
      
   if (isset($_GET['edit'])){
         $insertSql = "UPDATE patient SET `pacient_nomecompleto`='$pacient_nomecompleto', `email` ='$email', `address` ='$address', `cellphone` ='$cellphone', `about` ='$about', `password`='$hashed', `last_login`='$last_login', `permissions`='$permissions' WHERE id='$edit_id'";
                                    ...
                                    <form>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="pacient_nomecompleto" class="form-control" id="pacient_nomecompleto" value="<?=$pacient_nomecompleto?>" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Email</label>
                            ...
                            <table id="example5" class="display dataTablesCard table-responsive-xl">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$user['pacient_nomecompleto'];?></td>
                                        ...
                                        <td>
                                            <div class="dropdown ml-auto text-right">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="perfil.php?details=<?=$user['id'];?>">Ver Detalhes</a>

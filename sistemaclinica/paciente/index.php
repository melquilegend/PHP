...
$query=$db->query("SELECT * FROM consulta WHERE patient_id = '$idconsultaid' ORDER BY consultaid");
 $userCount = mysqli_num_rows($query);
 $result=$db->query("SELECT * FROM relatorio_consulta WHERE patient_id = '$idconsultaid' ORDER BY relatorio_id");
 $resultCount = mysqli_num_rows($result);
 $receita=$db->query("SELECT * FROM receita_medica WHERE patient_id = '$idconsultaid' ORDER BY receita_id");
 $receitaCount = mysqli_num_rows($receita);
?>
<body>
			...
			<div class="container-fluid">
				<div class="form-head d-flex align-items-center mb-sm-4 mb-3">
					<div class="mr-auto">
						...
						<p class="mb-0">Clínica Arco-íris</p>
					</div>
							...
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body mr-3">
										...
										<span>Total de Minhas consultas</span>
									</div>
					...
					<div class="col-xl-3  col-sm-6">
						<div class="card">
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body mr-3">
										<h2 class="fs-34 text-black font-w600"><?=$receitaCount?></h2>
					...
					<div class="col-xl-3  col-sm-6">
						<div class="card">
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body mr-3">
										<h2 class="fs-34 text-black font-w600"><?=$resultCount?></h2>

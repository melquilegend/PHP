...
?>
            ...
            <div class="container-fluid">
                <div class="form-head d-flex mb-sm-4 mb-3">
                    <div class="mr-auto">
                        ...
                        <p class="mb-0">Receitas  Emitidas</p>
                    </div>
                </div>
  ...
  $sql = "SELECT receita_medica.receita_id, receita_medica.doctor_id, receita_medica.patient_id, receita_medica.consulta_id, receita_medica.relatorio_id, receita_medica.num_receita, receita_medica.descricao, receita_medica.comentario_medico, relatorio_consulta.relatorio_id, relatorio_consulta.consulta_id, relatorio_consulta.doctor_id, relatorio_consulta.patient_id, relatorio_consulta.num_relatorio, relatorio_consulta.resultado, relatorio_consulta.comentario_medico, patient.pacient_nomecompleto, patient.id, patient.cellphone, patient.email, doctores.full_name, doctores.especialidade, doctores.cellphone, doctores.id, consulta.data_consulta FROM receita_medica LEFT JOIN relatorio_consulta ON receita_medica.relatorio_id = relatorio_consulta.relatorio_id LEFT JOIN doctores ON relatorio_consulta.doctor_id = doctores.id LEFT JOIN patient ON relatorio_consulta.patient_id = patient.id LEFT JOIN consulta ON relatorio_consulta.consulta_id = consulta.consultaid WHERE relatorio_consulta.patient_id =  '$idconsultaid'";
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-group   input-danger">
                                                    <div class="input-group-prepend">
                                                     ...
                                                     <textarea class="form-control" name="motivo_consulta" ><?=$motivo_consulta?></textarea>
                                                </div>
                                            </div>
                                             <div class="form-group col-md-6">
                                                ...
                                                <div class="input-group   input-danger">
                                                    <div class="input-group-prepend">
                                                     ...
                                                     <textarea class="form-control" name="sintomas" ><?=$sintomas?></textarea>
                                                </div>
                                            </div>
                            ...
                            <table id="example5" class="display dataTablesCard table-responsive-xl">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="text-nowrap"><?=$consulta['num_receita'];?></span></td>
                                        ...
                                        <td>
                                            <div class="dropdown ml-auto text-right">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="receita/index.php?details=<?=$consulta['receita_id'];?>">Imprimir</a>

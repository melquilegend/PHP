          ...
          <div class="content-body">
            ...
            <div class="container-fluid">
                <div class="form-head d-flex mb-sm-4 mb-3">
                    <div class="mr-auto">
                        <h2 class="text-black font-w600">Relatorios (Resultados) </h2>
                        <p class="mb-0">Resultados Emitidos</p>
                    </div>
                </div>
                            ...
                            <table id="example5" class="display dataTablesCard table-responsive-xl">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="text-nowrap"><?=$consulta['num_relatorio'];?></span></td>
